...
void linklist::add_last(int m_data)
{
/*Enter you code here*/
/*test code: {0, -1}*/
...
int main()
{
    ...
    {
        data = rand() % max_data;
        li.add_last(data); // add item to end of list
        li.display();
        ...
        redirect_stream << data << endl; // last link
